...
func main() {
	...
	jwtMiddleware := jwtmiddleware.New(jwtmiddleware.Options{
		ValidationKeyGetter: func(token *jwt.Token) (interface{}, error) {
			...
			// Verify 'iss' claim
			iss := "https://dev-hel98ena.eu.auth0.com/"
	...
	http.ListenAndServe(":8082", corsWrapper.Handler(r))
}
...
func getPemCert(token *jwt.Token) (string, error) {
	cert := ""
	resp, err := http.Get("https://dev-hel98ena.eu.auth0.com/.well-known/jwks.json")
